...
create_boot_risk_one=function(data.boot, confounders=c(), Para, n.cate, a, intv=4, intval=c(0,1)){
    n.cate1=n.cate-1
    out.reg.bt<- clm(Y ~ 1, nominal=Para, data=data.boot, link="probit")
    s.reg.bt<- lm(S~.-Y, data=data.boot)
    q.reg.bt<- lm(Q~.-Y-S, data=data.boot)
    ...
    if(intv==3){
      ...
      w111<- rep(intval[2],3)
      p000<- rho(theta.hat.bt,sig.hat.bt,n.para,Name=c("W","Q","S"),n.cate1,a,w000,confounders)
      p100<- rho(theta.hat.bt,sig.hat.bt,n.para,Name=c("W","Q","S"),n.cate1,a,w100,confounders) #first part of difference
      p110<- rho(theta.hat.bt,sig.hat.bt,n.para,Name=c("W","Q","S"),n.cate1,a,w110,confounders) #first part of difference
      p111<- rho(theta.hat.bt,sig.hat.bt,n.para,Name=c("W","Q","S"),n.cate1,a,w111,confounders) #first part of difference
      ...
      p0000<- rho(theta.hat.bt,sig.hat.bt,n.para,Name=c("W","Q","S"),n.cate1,a,w0000,confounders)
      p1000<- rho(theta.hat.bt,sig.hat.bt,n.para,Name=c("W","Q","S"),n.cate1,a,w1000,confounders) #first part of difference
      p1100<- rho(theta.hat.bt,sig.hat.bt,n.para,Name=c("W","Q","S"),n.cate1,a,w1100,confounders) #first part of difference
      p1110<- rho(theta.hat.bt,sig.hat.bt,n.para,Name=c("W","Q","S"),n.cate1,a,w1110,confounders) #first part of difference
      p1111<- rho(theta.hat.bt,sig.hat.bt,n.para,Name=c("W","Q","S"),n.cate1,a,w1111,confounders) #first part of difference
        RD1<- p1000[1]-p0000[1]
        RD2<- p1100[1]-p1000[1]
        RD3<- p1110[1]-p1100[1]
        RD4<- p1111[1]-p1110[1]
